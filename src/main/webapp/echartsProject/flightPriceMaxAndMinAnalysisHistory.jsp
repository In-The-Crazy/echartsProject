...
<head>
    ...
    <script type="text/javascript" src="<%=root%>/js/echartsProject/flightPriceMaxAndMinAnalysisHistory.js"></script>
...
<div class="div_grid" align="center">
    <div id="toolbar" class="toolbar" border="false">
            ...
            <div align="left">
                <form id="conditionForm" name="conditionForm">
                    ...
                    <fieldset  style="width: 250px;!important;">
                        <input id="takeOffTimeStart" name="takeOffTimeStart" class="easyui-datebox easyui-validatebox">
                    </fieldset>
                    <fieldset  style="width: 250px;!important;">
                        <input id="takeOffTimeEnd" name="takeOffTimeEnd" class="easyui-datebox easyui-validatebox">
                    </fieldset>
        ...
        <div id="secondChart" style="width: 95%;height: 300px;margin-top: 50px;margin-left: 50px;"></div>
        <div  id="jzhb" align="left" style="margin-top: 30px;width: 95%">

        </div>
        <div id="thirdChart" style="width: 95%;height: 300px;margin-top: 50px;margin-left: 50px;margin-bottom: 50px;"></div>
